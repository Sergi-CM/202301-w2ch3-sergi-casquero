const generatePopup = () => {
    ...
    popupText.textContent = "Use the coordinates to set the ship starting point and the direction buttons to set its direction. Be careful not to intersect two ships nor to place it outside the grid. Once you've placed them all, click on Start Game.";
