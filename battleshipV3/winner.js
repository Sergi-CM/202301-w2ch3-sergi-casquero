...
const checkWinner = (player) => {
    ...
    if (isWinner) {
        ...
        let whoWon = player === global.playerShips ? "CPU" : global.playerName.toLocaleUpperCase();
...
const generateResults5 = () => {
    ...
    resultsCounter(Math.floor(global.onTarget/global.shots*100), accuracyCounter, '%');
...
const generateResultsShips = () => {
    ...
    global.playerShips.map((ship) => {
        ...
        shipImg.src = ship.isSunk ? `./assets/${ship.shipName}2.png` : `./assets/${ship.shipName}.png`;
