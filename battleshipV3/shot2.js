...
const enemyShot = () => {
    ...
    let randomShot = global.playerBoard[randomRow][randomColumn];
    ...
    if (randomShot === "X") {
        ...
        setTimeout(function() {
            ...
            switch (randomShot) {
                case " ":
                    let squareSplash = document.querySelector(".player-" + randomRow + "-" + randomColumn);
                    splashPlayer(squareSplash);

                    global.playerBoard[randomRow][randomColumn] = "X";
                    let squareShot = document.querySelector(".player-" + randomRow + "-" + randomColumn);
                ...
                case "A":
                    global.playerShips.map((ship) => {
                        if(ship.letter === randomShot) {
                            ship.hits++
                            let squareText = document.querySelector(".player-" + randomRow + "-" + randomColumn);
                    ...
                    let squareColor = document.querySelector(".player-" + randomRow + "-" + randomColumn);
                    squareColor.classList.add("shot");
