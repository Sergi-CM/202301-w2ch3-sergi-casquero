let numero1 = prompt("Escriba primer número");
let numero2 = prompt("Escriba segundo número");

let resultados = []; 

const suma = (numero1, numero2) => {
    var sumRes = Number(numero1) + Number(numero2);
...
const resta = (numero1, numero2) => {
    var resRes = Number(numero1) - Number(numero2);
...
const mult = (numero1, numero2) => {
    var multRes = Number(numero1) * Number(numero2);
...
const div = (numero1, numero2) => {
    var divRes = Number(numero1) / Number(numero2);
